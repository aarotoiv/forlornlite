...
void Map::draw() {
	//stage level
	std::cout << "STAGE " << std::to_string(stage) << std::endl;
...
//damage dealt is strength multiplied with a slightly rngish modifier
...
//debugger function to just quickly output enemy hps and strengths
//not in use in prod
void Map::enemyDebug() {
	for (int i = 0; i < enemies.size(); i++) {
